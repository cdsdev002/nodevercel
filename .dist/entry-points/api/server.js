...
async function startWebServer() {
    ...
    console.log(configurationProvider.getValue('jwtTokenSecret'));
    // expressApp.use(
    ...
    console.log('pass Mid3');
    return APIAddress;
}
exports.startWebServer = startWebServer;
async function stopWebServer() {
    console.log('pass Mid Stop');
...
async function openConnection(expressApp) {
    return new Promise((resolve) => {
        ...
        console.log(portToListenTo);
        const webServerPort = portToListenTo || 5001;
